...
import com.example.capstonestage2.adapters.CoinSearchAdapter;
import com.example.capstonestage2.databases.MainViewModel;
import com.example.capstonestage2.databases.TransactionDatabase;
import com.example.capstonestage2.fragments.CoinsInfoFragment;
import com.example.capstonestage2.fragments.Portfolio24hGraphFragment;
import com.example.capstonestage2.fragments.PortfolioFragment;
import com.example.capstonestage2.fragments.PortfolioPieChartFragment;
import com.example.capstonestage2.fragments.RocketImageFragment;
import com.example.capstonestage2.models.Coin;
import com.example.capstonestage2.models.CoinAtTime;
import com.example.capstonestage2.models.Portfolio;
import com.example.capstonestage2.models.PortfolioAtTime;
import com.example.capstonestage2.models.Transaction;
import com.example.capstonestage2.services.CoinSearchDialogCompat;
import com.example.capstonestage2.services.CoinServiceInterface;
import com.example.capstonestage2.utils.JsonUtils;
...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void createRocketImageFragment(double change24hPct) {
        ...
        FragmentTransaction ft = fm.beginTransaction();//R.id.rocket_image_fragment_container, mRocketImageFragment
